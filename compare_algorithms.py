        ...
        for algo in algo_list:   
            ...
            for n_samples, n_features in zip(n_samplesvec, n_featuresvec):
                    for n_informative in n_informativevec:
                        filename = path_results  + 'fix{}_n_samples{:d}_n_feat{:d}_n_inform{:d}_bruit{:2.2f}_N{:d}_tol{:2.5e}'.format(algo,n_samples,n_features,n_informative,sigma_bruit,N,tol)
